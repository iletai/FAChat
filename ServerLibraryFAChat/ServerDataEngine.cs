...
namespace FAChatServerLibrary
{
    public static class ServerDataEngine
    {
        ...
        private static readonly string sr_sqlConnectionString = @"Data Source=LT\SQLEXPRESS;Initial Catalog=FAChat;Integrated Security=True";
